...
type HTrTransactionDetails struct {
	BaseModel

	HTransactionDetailID uuid.UUID  `gorm:"primaryKey;type:uuid" json:"h_transaction_detail_id"`
	TransactionDetailID  uuid.UUID  `gorm:"type:uuid" json:"transaction_detail_id"`
